...
const VehicleFinancingStep: React.FC<VehicleFinancingStepProps> = memo(({ 
  isFinanced, 
  onChange, 
  error 
}) => {
                ...
                <div key={option.value} className="relative">
                  ...
                  >
                    ...
                    <span className={`text-lg font-semibold ${
                      isFinanced === option.value ? 'text-blue-700' : 'text-gray-700'
                    }`}>
                      {option.label}
                    </span>
                  </Label>
...
VehicleFinancingStep.displayName = 'VehicleFinancingStep';

...
interface PersonTypeSelectionStepProps {
  personType: string;
  onSelect: (value: string) => void;
}

const PersonTypeSelectionStep: React.FC<PersonTypeSelectionStepProps> = ({ 
  personType, 
  onSelect 
}) => {
  const options = [
...
export default PersonTypeSelectionStep;
